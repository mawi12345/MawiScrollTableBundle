...
(function() {
  ...
  ScrollTable = (function() {
    ...
    function ScrollTable(options) {
      ...
      this.settings.lineHeight = this.el.find(this.settings.selector.row).first().outerHeight();
    ...
    ScrollTable.prototype.refresh = function() {
      ...
      return this.resize(function() {
        _this.el.find(_this.settings.selector.row).remove();
    ...
    ScrollTable.prototype.fill = function() {
      ...
      rows = this.el.find(this.settings.selector.row);
    ...
    ScrollTable.prototype.scroll = function() {
      var endrow, startrow, viewendrow, viewheight, viewstartrow, viewtop;
    ...
    ScrollTable.prototype.loadRows = function(start, end) {
      ...
      return $.ajax({
        ...
        success: function(response) {
          ...
          rows = $(response).find(_this.settings.selector.row);
